...
public class ServiceProviderDAO {
	...
	public ServiceProviderInfoTable findbyUsername(String uname) {
		List<ServiceProviderInfoTable> list = repo.findByserviceProviderUsername(uname);
		ServiceProviderInfoTable sp = list.get(0);
		return sp;
	}

	public ServiceProviderInfoTable findbyEmail(String email) {
		List<ServiceProviderInfoTable> list = repo.findByserviceProviderEmail(email);
		ServiceProviderInfoTable sp = list.get(0);
		return sp;
	}
}
