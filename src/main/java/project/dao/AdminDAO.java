...
public class AdminDAO {
	...
	public void updateAdmin(int id, String fname, String lname, String mobno, String email, String uname,
			String password) {
	...
	public AdminInfoTable findbyUsername(String uname) {
		List<AdminInfoTable> list = repo.findByadminUsername(uname);
		AdminInfoTable adm = list.get(0);
		return adm;
	}

	public AdminInfoTable findbyEmail(String email) {
		List<AdminInfoTable> list = repo.findByadminEmail(email);
		AdminInfoTable adm = list.get(0);
		return adm;
	}
}
