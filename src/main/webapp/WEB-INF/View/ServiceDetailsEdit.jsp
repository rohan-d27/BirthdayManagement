...
<head>
<title>Service Details Ediit</title>
<meta charset="utf-8">
<meta name="viewport"
...
<div id="wrapper">
	...
	<body oncontextmenu='false' class='snippet-body'style="background-color: #ccad00;"></body>
        ...
        <% ServicesInfoTable Service1=(ServicesInfoTable)request.getAttribute("Services");%>
			<div class="row">
               	<form method="POST" action="/ServiceUpdate" >
				<div class="col-md-4">
				...
				<div class="col-md-4">
					<div class="d-flex flex-column align-items-center text-center p-3 py-5">
						<h2>
							<span class="font-weight-bold">Edit Service</span>
						</h2>
					</div>
					<div class="row mt-2">
						<div class="col-md-12">
							<label class="labels">Service Id</label>
							 <input type="text" class="form-control" name="serviceId" value="<%=Service1.getServiceId()%>" readonly />
						</div>
						<div class="col-md-12">
							<label class="labels">Service Name</label> 
							<input type="text" class="form-control" name="serviceName" value="<%=Service1.getServiceName()%>" />
						</div>
					</div>
					...
					<div class="row mt-3">
						<div class="col-md-12">
							<label class="labels">Service Description</label>
							 <input type="text" name="serviceDesc" class="form-control" value="<%=Service1.getServiceDesc()%>" />
						</div>
						<div class="col-md-12">
              	    <label class="labels">Service Cost </label> 
              	    <input type="text" class="form-control" name="servicePrice" value="<%=Service1.getServicePrice()%>" />
						</div>
