                ...
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-3" >
                        <form action="/ServiceProviderVerify" method="post">
                            ...
                            <!-- Submit button -->
                            <button class="btn btn-primary profile-button  btn-block mb-4" type="submit">Login</button>
                            <!-- <button type="submit" class="btn btn-primary btn-block mb-4">Sign in</button> -->
                        
                            <!-- Register buttons -->
                            <div class="text-center">
                            <p>Not a member? <a href="/ServiceProviderRegister" style="font-size: medium; color: #448dc2;">Register</a></p>
