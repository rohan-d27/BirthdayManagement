...
<div id="wrapper">
	...
	<br>
	<br>
	<body oncontextmenu='false' class='snippet-body'style="background-color: #ccad00;"></body>
		<div class="container rounded bg-white mt-5 mb-5"
			style="background-color: #ccad00;">
  
        <%  
            PackagesInfoTable package1=(PackagesInfoTable)request.getAttribute("packageData");
                 session.setAttribute("package", package1);
            %>
          
			<div class="row">
               	<form method="POST" action="/packageupdate" >
				...
				<div class="col-md-4">
					<div class="d-flex flex-column align-items-center text-center p-3 py-5">
						<h2>
							<span class="font-weight-bold">Edit Package</span>
						</h2>
					</div>
					<div class="row mt-2">
						<div class="col-md-12">
							<label class="labels">Package Id</label>
							 <input type="text" class="form-control" name="packageId" value="<%=package1.getPackageId() %>" readonly />
						</div>
						<div class="col-md-12">
							<label class="labels">Package Name</label> 
							<input type="text" class="form-control" name="packageName" value="<%=package1.getPackageName()%>" />
						</div>
					</div>
					...
					<div class="row mt-3">
						<div class="col-md-12">
							<label class="labels">Package Description</label>
							 <input type="text" name="packageDesc" class="form-control" value="<%=package1.getPackageDesc()%>" />
						</div>
						<div class="col-md-12">
              	    <label class="labels">Package Cost </label> 
              	    <input type="text" class="form-control" name="packagePrice" value="<%=package1.getPackagePrice()%>" />
						</div>
                               ...
                               <button class="btn btn-primary profile-button" type="submit"> <a  style="text-decoration: none;color: #fff;">Save Changes</a>  
                               </button>
                               
                                <button class="btn btn-primary profile-button" type="button"> <a href="/PackageServicesList" style="text-decoration: none;color: #fff;">Edit Services</a>  </button>
                                </div>
						<br> <br> <br>
					</div>
