                        ...
                        <nav>
                            <ul id="mainmenu">
                                ...
                                <%
                                  ...
                                  %>
                                   <li>
                                     <a href="/SeviceProviderDashboard"><%=serviceprovider.getServiceProviderFname()+" "+serviceprovider.getServiceProviderLname() %></a>
                                    <ul>
               ...
               <div class="container rounded bg-white mt-5 mb-5"  style="background-color: #ccad00;">
                       ...
                       <div class="row mt-3">
                           ...
                           <input type="text" class="form-control" placeholder="Email" value="<%=serviceprovider.getServiceProviderEmail()%>" readonly></div>
                                   ...
                                   <a href="/SeviceProviderDashboard" style="text-decoration: none;color: #fff;">Change Profile</a>  </button>
                                   <br>
                                   <br>
                                   <br>
                                   </div>
