                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center fadeScroll relative" data-scroll-speed="2">
                            <h2 data-scroll-speed="8">Music</h2>
                    ...
                    <div class="blog-list">
                            ...
                            <div class="post-content">
                                <div class="post-image">
                                    <figure class="picframe img-rounded mb20">
                                        ...
                                        <a class="image-popup" href="images_02/music/hiphop.jpg">
                                            <span class="overlay-v">
                                                <i></i>
                                            </span>
                                        </a>
                                        <img src="images_02/music/hiphop.jpg"
                                ...
                                <div class="post-wrapper">
                                    ...
                                    <div class="post-text">
                                        <h3>Hip-Hop Music</h3>
                                        <p>It consists of a stylized rhythmic music that commonly accompanies rapping, a rhythmic and rhyming speech that is chanted.</p>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="post-content">
                                <div class="post-image">
                                    <figure class="picframe img-rounded mb20">
                                        <a class="image-popup" href="images_02/music/rock.jpg">
                                            <span class="overlay-v">
                                                <i></i>
                                            </span>
                                        </a>
                                        <img src="images_02/music/rock.jpg"
                                ...
                                <div class="post-wrapper">
                                    ...
                                    <div class="post-text">
                                        <h3>Rock Music</h3>
                                        <p>It is based around amplified instruments, especially the electric guitar and electric bass, and is characterized by a strong bass line and driving rhythms.</p>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="post-content">
                                <div class="post-image">
                                    <figure class="picframe img-rounded mb20">
                                        <a class="image-popup" href="images_02/music/fusion.jpg">
                                            <span class="overlay-v">
                                                <i></i>
                                            </span>
                                        </a>
                                        <img src="images_02/music/fusion.jpg"
                                ...
                                <div class="post-wrapper">
                                    ...
                                    <div class="post-text">
                                        <h3>Fusion Music</h3>
                                        <p>Fusion music usually combines two different styles.Successful fusion music is often controversial as it tries to combine the traditional and the new, mixing things up.</p>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="post-content">
                                <div class="post-image">
                                    <figure class="picframe img-rounded mb20">
                                        <a class="image-popup"
                                            href="images_02/music/folk.jpg">
                                            <span class="overlay-v">
                                                <i></i>
                                            </span>
                                        </a>
                                        <img src="images_02/music/folk.jpg"
                                ...
                                <div class="post-wrapper">
                                    ...
                                    <div class="post-text">
                                        <h3>Folk Music</h3>
                                        <p>Folk music, type of traditional and generally rural music that originally was passed down through families and other small social groups.</p>
                                    </div>
