               ...
               <div class="container rounded bg-white mt-5 mb-5"  style="background-color: #ccad00;">
                       ...
                       <div class="row mt-3">
                           ...
                           <input type="text" class="form-control" placeholder="Email" value="<%=admin.getAdminEmail()%>" readonly></div>
                                   ...
                                   <a href="/AdminDashboardPackageDetails" style="text-decoration: none;color: #fff;">Change Profile</a>  </button>
                                   <br>
                                   <br>
                                   <br>
                                   </div>
                                           ...
                                           <table class="table table-bordered">
                                               ...
                                               for(OrdersInfoTable obj :orderlist)
                                               {
                                                   ...
                                                   %>
                                                    ...
                                                    <td>
                                                    <form action="/orderstatusconfirm" method="post">
                                                    <input type="hidden" name="id" value="<%=id%>">
                                                     ...
                                                     <td>
                                                     <form action="/orderstatusreject" method="post" >  
                                                     <input type="hidden" name="id" value="<%=id%>"> 
