    ...
    <body oncontextmenu='return false' class='snippet-body'>
        <div class="container rounded bg-white mt-5 mb-5"><!-- bg-#ccad00 -->
            <div class="col-md-3">
                ...
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-3" >
                        <form action="/CustomerVerify" method="post">
                            ...
                            <input type="text" id="form2Example1" class="form-control" name="customerUsername" />
                            ...
                            <input type="password" id="form2Example2" class="form-control" name="customerPassword" />
                            ...
                            <div class="col">
                                <!-- Simple link -->
                                <a href="/CustomerForgot" style="font-size: medium; color: #448dc2;">Forgot password?</a>
                            </div>
                            </div>
                        
                            <!-- Submit button -->
                            <button class="btn btn-primary profile-button  btn-block mb-4" type="submit">Sign in</button>
                            <!-- <button type="submit" class="btn btn-primary btn-block mb-4">Sign in</button> -->
                        
                            <div class="text-center">
                            <p>Not a member? <a href="/CustomerRegister" style="font-size: medium; color: #448dc2;">Register</a></p>
