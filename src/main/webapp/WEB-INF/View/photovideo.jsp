...
<head>
    <meta charset="utf-8">
    <title>Photos Video Service</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center fadeScroll relative" data-scroll-speed="2">
                            <h2 data-scroll-speed="8">Photo/Videography</h2>
                    ...
                    <div class="blog-list">
                            ...
                            <div class="post-content">
                                <div class="post-image">
                                    <figure class="picframe img-rounded mb20">
                                        ...
                                        <a class="image-popup" href="images_02/photoghraphy/basic.jpg">
                                            <span class="overlay-v">
                                                <i></i>
                                            </span>
                                        </a>
                                        <img src="images_02/photoghraphy/basic.jpg"
                                ...
                                <div class="post-wrapper">
                                    ...
                                    <div class="post-text">
                                        <h3>Basic Plan</h3>
                                        <p>It may contain basic limited photographs with single short video.</p>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="post-content">
                                <div class="post-image">
                                    <figure class="picframe img-rounded mb20">
                                        <a class="image-popup" href="images_02/photoghraphy/matt.jpg">
                                            <span class="overlay-v">
                                                <i></i>
                                            </span>
                                        </a>
                                        <img src="images_02/photoghraphy/matt.jpg"
                                ...
                                <div class="post-wrapper">
                                    ...
                                    <div class="post-text">
                                        <h3>Pro Plan</h3>
                                        <p>It may contain matte photo printing with well edited short plus long video.</p>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="post-content">
                                <div class="post-image">
                                    <figure class="picframe img-rounded mb20">
                                        <a class="image-popup" href="images_02/photoghraphy/canvas.jpg">
                                            <span class="overlay-v">
                                                <i></i>
                                            </span>
                                        </a>
                                        <img src="images_02/photoghraphy/canvas.jpg"
                                ...
                                <div class="post-wrapper">
                                    ...
                                    <div class="post-text">
                                        <h3>Altra Plan</h3>
                                        <p>It may contain canvas printing of photographs with motiongraphic video and one cinematic video.</p>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="post-content">
                                <div class="post-image">
                                    <figure class="picframe img-rounded mb20">
                                        <a class="image-popup"
                                            href="images_02/photoghraphy/spring.jpg">
                                            <span class="overlay-v">
                                                <i></i>
                                            </span>
                                        </a>
                                        <img src="images_02/photoghraphy/spring.jpg"
                                ...
                                <div class="post-wrapper">
                                    ...
                                    <div class="post-text">
                                        <h3>Platinum Plan</h3>
                                        <p>It may contain spring printed photoghraphs with live action screencast video and one cinematic video.</p>
                                    </div>
