    ...
    <div id="wrapper">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="contact.html" class="btn-rsvp">Contact</a>
                    ...
                    <div class="blog-list">
                            ...
                            <div class="post-content">
                                ...
                                <div class="post-wrapper">
                                    ...
                                    <div class="post-text">
                                        ...
                                        <p>Hot buffet caterers provide hot foods that are delivered from
                                            their commissaries in insulated containers. They sometimes
                                            provide serving personnel at an additional charge. </p>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="post-content">
                                <div class="post-image">
                                    <figure class="picframe img-rounded mb20">
                                        <a class="image-popup" href="images_02/caterers/full-service.jpg">
                                            <span class="overlay-v">
                                                <i></i>
                                            </span>
                                        </a>
                                ...
                                <div class="post-wrapper">
                                    ...
                                    <div class="post-text">
                                        ...
                                        <p>Full-service caterers not only provide food, but frequently
                            ...
                            <div class="post-content">
                                ...
                                <div class="post-wrapper">
                                    ...
                                    <div class="post-text">
                                        ...
                                        <p>The guests sit down on their respective seats while the caterer has people moving around with trays of food or drinks on them. The caterers go asking the guests what they would love to take, and come back later with their meals and drinks. This type of service is suitable for an elegant event but is usually time consuming and a bit expensive.</p>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="post-content">
                                <div class="post-image">
                                    <figure class="picframe img-rounded mb20">
                                        <a class="image-popup"
                                            href="images_02/caterers/outdoor.jpg">
                                            <span class="overlay-v">
                                                <i></i>
                                            </span>
                                        </a>
                                ...
                                <div class="post-wrapper">
                                    ...
                                    <div class="post-text">
                                        ...
                                        <p>This catering includes the provision of food and drink away
                                            from venue base and suppliers like garden or club.They will provide full service according to strength of members.But in this strength should be already defined.</p>
                                    </div>
        ...
        <footer>
            <div class="container text-center text-light">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="hs1 wow fadeInUp">Sit<span>&amp;</span>Laugh</h2>
                    </div>
                </div>
            </div>
