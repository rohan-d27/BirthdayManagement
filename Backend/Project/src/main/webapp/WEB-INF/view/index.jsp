                        ...
                        <nav>
                            <ul id="mainmenu">
                                <li><a href="index.html">Home</a>
									<ul>
                                        <li><a href="${contextPath}/admin/listPeople">Service</a></li>
                                ...
                                <li><a href="login-form/Login.html">User Login</a></li>
                                <li><a href="login-form/Login.html">Business Login</a>
                                    <ul>
                                    <li><a href="login.html">Admin</a></li>
                                    <li><a href="login.html">Service Provider</a></li>
                                  </ul>
                                </li>
                                        ...
                                        <div class="col-sm-4">
                                                <div class="pricing-s1 mb30">
                                                    <div class="top">
                                                        ...
                                                        <p class="price"><span class="currency"> &#8377;</span> <b>30000</b>
                                                    </div>
                                                    <div class="bottom">
                                                        <ul>
                                                        ...
                                                        <a href="02_contact.html" class="btn btn-custom">Buy</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="pricing-s1 mb30">
                                                    <div class="top">
                                                        ...
                                                        <p class="price"><span class="currency"> &#8377;</span> <b>40000</b>
                                                    </div>
                                                    <div class="bottom">
                                                        <ul>
                                                            <li><i class="icon_check"></i>Birthday Cake</li>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="pricing-s1 mb30">
                                                    ...
                                                    <div class="top">
                                                        ...
                                                        <p class="price"><span class="currency"> &#8377;</span> <b>35000</b>
                                                    </div>
                                                    <div class="bottom">
                                                        <ul>
                                                            <li><i class="icon_check"></i>Birthday Cake</li>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="pricing-s1 mb30">
                                                    <div class="top">
                                                        ...
                                                        <p class="price"><span class="currency"> &#8377;</span> <b>70000</b>
                                                    </div>
                                                    <div class="bottom">
                                                        <ul>
                                                            <li><i class="icon_check"></i>Birthday Cake</li>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="pricing-s1 mb30">
                                                    ...
                                                    <div class="bottom">
                                                        ...
                                                        <a href="02_contact.html" class="btn btn-custom">Make</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
          ...
          <!--  <section id="section-services" class="text-light" data-bgcolor="#b28f1d">
                <div class="container">
                            <div class="row">
								...
								<div class="col-md-3 text-center">
									<img src="images_02/services/4.png" alt="" class="img-circle mb30"/>
                                    <h4>Packages</h4>
									Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur.
                                </div>
                            </div>
