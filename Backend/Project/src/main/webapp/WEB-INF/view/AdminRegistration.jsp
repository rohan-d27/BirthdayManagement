                ...
                <div class="row mt-2" >
                    <form  method="post" action="/admin/insert">
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label for="mobileno" class="form-label">User Name</label> 
                          <input type="text "name="adminUsername" id="adminUsername"   class="form-control" placeholder="User Name" required>
                         </div>
                        <div class="form-group">
                        ...
                        <input type="email" name="adminEmail" id="email"  class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="Email" required>
                      </div>
                         <div class="form-group">
                            <label for="password" class="form-label">Password</label>      
                      <input id="password-field" name="adminPassword" type="password" class="form-control" placeholder="Password" required>
