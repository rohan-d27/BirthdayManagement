...
public class CustomerDAO  {
	...
	public void updateCustomer(int id, String fname,String lname, String mobno,String email,String address,String city,int zipcode,String uname,String password) 
	{     
