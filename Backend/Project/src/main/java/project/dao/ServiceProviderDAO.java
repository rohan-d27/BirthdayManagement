...
public class ServiceProviderDAO {
	...
	public void updateServiceProvider(int id, String fname,String lname, String mobno,String email,String address,String city,int zipcode,String uname,String password) 
	{     
