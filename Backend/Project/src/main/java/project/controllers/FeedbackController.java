...
public class FeedbackController {
	...
	@PostMapping(path = "/feedback/update", consumes = { MediaType.APPLICATION_FORM_URLENCODED_VALUE })
	...
	@PostMapping(path = "/feedback/delete", consumes = { MediaType.APPLICATION_FORM_URLENCODED_VALUE })
	public String deleteFeedback(@RequestBody FeedbackTable fb) throws Exception {

		daoFeedback.delete(fb);
		return "index";
	}
	@GetMapping(path = "/feedback/customerfeedbacklist", consumes = { MediaType.APPLICATION_FORM_URLENCODED_VALUE })
